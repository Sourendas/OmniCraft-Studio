/**
 * Minimal ZIP writer (store method, no compression). JPEG and PNG files are already
 * compressed, so storing them keeps the code small and avoids another dependency.
 */
