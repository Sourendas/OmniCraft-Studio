    ...
    <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="rounded-3xl bg-white border border-slate-200/90 p-8 sm:p-12 space-y-5 text-slate-700 text-sm leading-relaxed">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#EA580C] to-[#0F4C81] flex items-center justify-center">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li><Link className="text-[#C2410C] underline font-bold" to="/pdf-suite">PDF Suite</Link> — merge, split, watermark</li>
          ...
          <li><Link className="text-[#C2410C] underline font-bold" to="/qr-generator">QR Generator</Link>, <Link className="text-[#C2410C] underline font-bold" to="/dev-tools">Dev Tools</Link>, Markdown, SVG, Text Diff</li>
        </ul>
        <p>How-to: <Link to="/guides" className="text-[#C2410C] underline font-bold">Guides</Link>. Policy: <Link to="/privacy" className="text-[#C2410C] underline font-bold">Privacy</Link>, <Link to="/terms" className="text-[#C2410C] underline font-bold">Terms</Link>, <Link to="/cookie-policy" className="text-[#C2410C] underline font-bold">Cookies</Link>, <Link to="/contact" className="text-[#C2410C] underline font-bold">Contact</Link>.</p>
      </div>
    </div>
  );
};
