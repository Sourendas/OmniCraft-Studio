...
const TITLES: Record<Job, { h1: string; lead: string }> = {
  ...
  numbers: {
    h1: 'Add page numbers',
    lead: 'Numbers are drawn at the bottom centre of each page of the files you add, in list order.',
  },
};
    ...
    try {
      ...
      for (const file of Array.from(list)) {
        ...
        pages.forEach((page) => {
          ...
          page.drawText(String(n), { x: width / 2 - 4, y: 18, size: 10, font, color: rgb(0.2, 0.2, 0.2) });
          out.addPage(page);
          n += 1;
        });
      }
