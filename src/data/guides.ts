...
export const GUIDES: GuideArticle[] = [
    ...
    figures: [
      {
        ...
        alt: 'Diagram of the PDF Suite drop zone, several loaded files, and a Merge PDFs export panel',
        caption:
          'Interface diagram of merge in PDF Suite. Preview tiles on the live tool are placeholders, not rendered PDF pages.'
      }
    ],
    lead: [
    ...
    figures: [
      {
        ...
        alt: 'Diagram of a multi-page PDF with pages 2–4 selected and a page-range field',
    ...
    figures: [
      {
        ...
        alt: 'Diagram of a JPG going to a WebP export through the File Converter',
        caption:
          'JPEG has no transparency. If you start from a PNG with a clear background, pick PNG or WebP if you need the alpha channel.'
      }
    ],
    lead: [
    ...
    figures: [
      {
        ...
        alt: 'Diagram comparing a large original with a smaller canvas export',
    ...
    figures: [
      {
        ...
        alt: 'Diagram of the resume editor and a PDF preview',
        caption: 'Download PDF uses the current form. Empty fields are skipped.'
      }
    ],
    lead: [
    ...
    figures: [
      {
        ...
        caption: 'Test the code with a second phone before you print a stack of handouts.'
      }
    ],
    lead: [
  ...
  },
  {
    ...
    figures: [
      {
        src: '/guides/img/privacy-tab.svg',
